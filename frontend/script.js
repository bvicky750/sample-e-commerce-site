document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchProducts(searchTerm = '') {
        let url = '/api/products'; // URL updated
        if (searchTerm) { url = `/api/products/search?q=${searchTerm}`; } // URL updated
        try {
    ...
    async function loadUserData() {
        ...
        try {
            const res = await fetchWithAuth('/api/users/cart'); // URL updated
    ...
    async function addToCart(productId) {
        ...
        try {
            await fetchWithAuth('/api/users/cart', { // URL updated
                method: 'POST',
    ...
    async function handleCartActions(e) {
        ...
        try {
            await fetchWithAuth(`/api/users/cart/${productId}`, { method: 'DELETE' }); // URL updated
            await loadUserData();
    ...
    placeOrderButton.addEventListener('click', async () => {
        ...
        try {
            ...
            const res = await fetchWithAuth('/api/orders', { // URL updated
                method: 'POST',
